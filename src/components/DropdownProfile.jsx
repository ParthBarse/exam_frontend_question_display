    ...
    <div className="relative inline-flex">
      ...
      >
        ...
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-m font-medium dark:text-slate-300 group-hover:text-slate-800 dark:group-hover:text-slate-200">Marshal Cadet Force&nbsp;</span>
          <svg className="w-3 h-4 shrink-0 ml-1 fill-current text-slate-400" viewBox="0 0 12 14">
