                              ...
                              <div className="text-center grid grid-cols-2 grid-rows-2 gap-1">
                                    ...
                                    onClick={async () => {
                                      try {
                                        const response = await axios.get(
                                          `https://${baseurl}/sendEntranceCard?sid=${item.sid}`
                                        );
                                        console.log(response.data);
                                        // Show a success message
                                        toast(
                                          "Entrance card sent successfully!"
                                        );
                                      } catch (error) {
                                        console.error(error);
                                ...
                                <button
                                  ...
                                  onClick={async (e) => {
                                    setSmsLoading(true);
                                    const res = await axios.get(
                                      `https://${baseurl}/sendEntranceCard_sms?sid=${item.sid}`
                                    );
                                    toast("Entrance Card sent...");
                                    setSmsLoading(false);
                                  }}
                                >
                                  Send via SMS
                                ...
                                <button
                                  ...
                                  onClick={async (e) => {
                                    const res = await axios.get(
                                      `https://${baseurl}/sendEntranceCard_wp?sid=${item.sid}`
                                    );
                                    toast("Entrance Card sent...");
                                  }}
                                >
