                              ...
                              <div className="text-center grid grid-cols-2 grid-rows-1 gap-1">
                                    ...
                                    onClick={async () => {
                                      try {
                                        const response = await axios.get(
                                          `https://${baseurl}/sendMedicalCertificate?sid=${item.sid}`
                                        );
                                ...
                                <button
                                  ...
                                  onClick={async (e) => {
                                    setLoadingSms(true);
                                    const res = await axios.get(
                                      `https://${baseurl}/sendMedicalCertificate_sms?sid=${item.sid}`
                                    );
                                    toast("Medical Certificate sent...");
                                    setLoadingSms(false);
                                  }}
                                ...
                                <button
                                  ...
                                  onClick={async (e) => {
                                    const res = await axios.get(
                                      `https://${baseurl}/sendMedicalCertificate_wp?sid=${item.sid}`
                                    );
                                    toast("Medical Certificate sent...");
                                  }}
                                >
